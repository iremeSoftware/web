<template>
   <table class="mt-3 w-full  text-[11px] text-gray-500 dark:text-gray-400" :style="selected_type">
                <tbody class="border mt-2">
                     ...
                     <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700 " :class="`px-[${padding_steps.px}px] py-[${padding_steps.py}px]`">
                      <td rowspan="3" class="px-2 py-5 border w-10"  >
                       <b>SUBJECTS</b>
                       </td>
                     ...
                     <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700 ">
                       ...
                       <td class="px-2 py-5 border text-center" :class="`px-[${padding_steps.px}px] py-[${padding_steps.py}px]`">
                       <b>TOTAL</b>
                       </td>
                       <td class="px-2 py-5 border"  :class="`px-[${padding_steps.px}px] py-[${padding_steps.py}px]`">
                       <b>MID</b>
                       ...
                       <td colspan="3" class="px-2 py-5 border text-center" :class="`px-[${padding_steps.px}px] py-[${padding_steps.py}px]`">
                       <b>TOTAL</b>
                       </td>
                       <td rowspan="2" class="px-2 py-5 border text-center" :class="`px-[${padding_steps.px}px] py-[${padding_steps.py}px]`">
                       <b>CA(%)</b>
                       </td>
                       <td rowspan="2" class="px-2 py-5 border text-center" :class="`px-[${padding_steps.px}px] py-[${padding_steps.py}px]`">
                       <b>TOTAL</b>
                     ...
                     <tr v-for="marks in (is_for_all_students == 'true' ? getStudentRanks:getStudentRanks?.Marks)" class="bg-white border-b dark:bg-gray-900 dark:border-gray-700 ">
                      <td class="px-[5px] py-[16px] border">
                       ...
                       <td class="px-2 py-5 border">
                        <input type="hidden" :set="total_term3_class_maximum = total_maximum_term3 * student_total_number ">
                     ...
                     <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700 ">
                       ...
                       <td class="px-2 py-5 border">
                        <b>{{ general_CAT_total_marks_term1.toFixed(0) }}/{{ general_CAT_total_maximum_term1 }}</b>
                       </td>
                       <td class="px-2 py-5 border">
                       <b>{{ general_EXAM_total_marks_term1.toFixed(0) }}/{{ general_EXAM_total_maximum_term1 }}</b>
                       </td>
                       <td class="px-2 py-5 border">
                        ...
                        <b>{{ general_total_marks_CAT_EXAM.toFixed(0) }}/{{ general_total_maximum_CAT_EXAM }}</b>
                       </td>


                       <td class="px-2 py-5 border">
                        <b>{{ general_CAT_total_marks_term2.toFixed(0) }}/{{ general_CAT_total_maximum_term2 }}</b>
                       </td>
                       <td class="px-2 py-5 border">
                       <b>{{ general_EXAM_total_marks_term2.toFixed(0) }}/{{ general_EXAM_total_maximum_term2 }}</b>
                       </td>
                       <td class="px-2 py-5 border">
                        ...
                        <b>{{ general_total_marks_CAT_EXAM_term2.toFixed(0) }}/{{ general_total_maximum_CAT_EXAM_term2 }}</b>
                       </td>

                       <td class="px-2 py-5 border">
                        <b>{{ general_CAT_total_marks_term3.toFixed(0) }}/{{ general_CAT_total_maximum_term3 }}</b>
                       </td>
                       <td class="px-2 py-5 border">
                       <b>{{ general_EXAM_total_marks_term3.toFixed(0) }}/{{ general_EXAM_total_maximum_term3 }}</b>
                       </td>
                       <td class="px-2 py-5 border">
                        ...
                        <b>{{ general_total_marks_CAT_EXAM_term3.toFixed(0) }}/{{ general_total_maximum_CAT_EXAM_term3 }}</b>
                       </td>
                       <td class="px-2 py-5 border">
                       <b>{{ ((general_total_marks_CAT_EXAM_term3.toFixed(0) / general_total_maximum_CAT_EXAM_term3) * 100).toFixed(1) }}%</b>
                       </td>
                       ...
                       <td class="px-2 py-5 border">
                        ...
                        <b>{{ total_average_percentage.toFixed(0) }}%</b>
                       </td>
                       <td class="px-2 py-5 border">
                        ...
                        <b>{{ general_total_marks_annual.toFixed(0) }}/{{ general_total_marks_annual_maximum }}</b>
                       </td>
                       <td class="px-2 py-5 border">
                        <input type="hidden" :set="annual_percentage = (general_total_marks_annual / general_total_marks_annual_maximum ) * 100" />
                        <b>{{ annual_percentage.toFixed(1) }}%</b>
                       </td>
                     </tr>
                     <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700 ">
                        <td class="px-2 py-5 border">
                       ...
                       <td colspan="6"  class="px-2 py-5 border text-center">
                        <b>{{  (is_for_all_students == 'true' ? ranks.rank_term3 :  getStudentRanks?.Ranks?.rank_term3) }}/{{student_total_number }}</b>
                       </td>
                       <td colspan="2"  class="px-2 py-5 border text-center">
                        <b>
                          {{  (is_for_all_students == 'true' ? ranks.rank_annual :  getStudentRanks?.Ranks?.rank_annual) }}/{{student_total_number }}
                        </b>
                       </td>
            ...
            <table class="mt-3 w-full  text-[10px] text-left text-gray-500 dark:text-gray-400" :style="selected_type">
                <tbody class="border mt-2">
                  <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700 ">
                        <td rowspan="2" class="px-2 py-3 border">
                          <b>DECISION OF JURY</b>
                        </td>
                        <td class="flex px-2 py-3">
                          <b>Promoted</b>
                          <input type="checkbox" class="ml-4 h-[12px] w-[12px]">
