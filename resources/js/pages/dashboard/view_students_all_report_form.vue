    ...
    <div class="w-full flex" >
      ...
      <div class="w-full md:w-5/6">
        ...
        <DataTable>
          ...
          <div class="overflow-x-auto"  v-for="rank in getStudentRanks?.Ranks"  >
             <table class="w-full text-[9px] text-left text-gray-500 dark:text-gray-400" :style="formData.font_type">
                <tbody class="border">
                ...
                <template v-if="formData.report_type == 'advanced_report'">
                  ...
                  <FirstTermSingleReport v-if="formData.term ==1" :getStudentRanks="getStudentRanks?.Marks[rank.student_id]" :selected_type="formData.font_type" is_for_all_students="true" :student_total_number="getStudentRanks?.no_of_students"
                  :ranks="rank" 
                  :padding_steps="padding_steps" />

                  <SecondTermSingleReport v-if="formData.term ==2" :getStudentRanks="getStudentRanks?.Marks[rank.student_id]" :selected_type="formData.font_type" is_for_all_students="true" :student_total_number="getStudentRanks?.no_of_students" 
                  :ranks="rank" 
                  :padding_steps="padding_steps"/>

                  <ThirdTermSingleReport v-if="formData.term ==3" :getStudentRanks="getStudentRanks?.Marks[rank.student_id]" :selected_type="formData.font_type" is_for_all_students="true" :student_total_number="getStudentRanks?.no_of_students" 
                  :ranks="rank" 
                  :padding_steps="padding_steps"/>
                ...
                <template v-else-if="formData.report_type == 'mid_term_report'">
                  ...
                  <MidTermSingleReport :getStudentRanks="getStudentRanks?.Marks[rank.student_id]" 
                  :selected_type="formData.font_type" is_for_all_students="true"
                ...
                <table class=" w-full  text-[8px] text-left text-gray-500 dark:text-gray-400" :style="formData.font_type" >
                <tbody>
                  <tr class="bg-white dark:bg-gray-900 dark:border-gray-700 ">
                        <td>
...
<script>
  ...
  import FirstTermSingleReport from '../../components/report_form/advanced_reports_all/first_term_single_report.vue'
  import SecondTermSingleReport from '../../components/report_form/advanced_reports_all/second_term_single_report.vue'
  import ThirdTermSingleReport from '../../components/report_form/advanced_reports_all/third_term_single_report.vue'
    ...
    setup() {
      ...
      function checkAuth(){
        ...
        function setCurrentTerm(){
          ...
          router.push(`/dashboard/report_form/${formData.value.class_id}/all/${formData.value.term}`);
          getStudentsRanks()
        }
      ...
      function print_pdf() {
        ...
        function getStudentsRanks(){
            return studentsMarksStores.getAllStudentsMarks(formData.value)
        }
